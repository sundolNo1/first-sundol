...
int totalCount = dao.selectCount(param);  //계시물 수 확인
...
List<BoardDTO> boardLists = dao.selectListPage(param);   //게시글 목록 받기
dao.close();
%>
<!DOCTYPE html>
<html>
...
<%
	...
	//게시글이 있을때
	int virtualNum = 0; //화면상애서의 게시물 번호
	int countNum = 0;
	for(BoardDTO dto : boardLists)
	{
		// virtualNum = totalCount--; //전체 개시물 수에서 시작해 1씩 감소
